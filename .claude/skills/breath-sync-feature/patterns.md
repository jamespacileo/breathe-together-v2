...
const particle_radius = 2.8 - breathState.breathPhase * 1.6;   // 2.8-1.2
```

**Characteristics:**
- When sphere large (1.4), particles close (1.2)
- When sphere small (0.6), particles far (2.8)
