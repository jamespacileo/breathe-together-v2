...
export const VISUAL_DEFAULTS = {
  ...
  sphereColor: {
    ...
    meta: {
      whenToAdjust: 'Create visual focal point, align with brand palette, establish atmosphere',
      typicalRange:
  ...
  sphereOpacity: {
    ...
    meta: {
      ...
      performanceNote: 'Transparency requires blending pass; no significant impact',
    } as PropMetadata,
  },
  sphereSegments: {
    value: 64 as const,
    meta: {
      ...
      performanceNote: 'Significant GPU impact; each +16 segments ~1-2% more draw call time',
    } as PropMetadata,
  },
  starsCount: {
    value: 5000 as const,
    meta: {
      whenToAdjust: '1000-3000 for sparse (fast), 5000 for standard, 8000+ for dense (slower)',
      typicalRange:
        'Sparse (1000, individual stars) → Standard (5000, balanced) → Dense (10000, full field)',
      performanceNote: 'Linear impact on initialization; no runtime cost after creation',
    } as PropMetadata,
  },
  floorColor: {
  ...
  particleCount: {
    ...
    meta: {
      ...
      performanceNote: 'O(n) rendering via InstancedMesh; 300 = negligible, 500 = ~1-2% GPU cost',
    } as PropMetadata,
  },
} as const;
...
export const LIGHTING_DEFAULTS = {
  ...
  ambientColor: {
    ...
    meta: {
      whenToAdjust: 'Change mood: cool blue (calm, meditative), warm orange (energetic, warm)',
      typicalRange:
  ...
  keyPosition: {
    ...
    meta: {
      ...
      typicalRange: 'Front-right ([2, 3, 5]) → Right side ([5, 2, 0]) → Left side ([-5, 3, 2])',
      interactsWith: ['keyIntensity', 'rimColor'],
      performanceNote: 'No impact; lighting computed per-fragment',
    } as PropMetadata,
  },
  keyIntensity: {
    value: 1.2 as const,
    meta: {
      whenToAdjust: '0.8-1.2 for gentle, 1.2-1.8 for dramatic, >2.0 for blown-out highlights',
      typicalRange:
  ...
  keyColor: {
    ...
    meta: {
      whenToAdjust: 'Match theme: cool blue for meditative, warm for energetic',
      typicalRange: 'Cool (#4080ff, calm) → Neutral (#ffffff, balanced) → Warm (#ff9900, warm)',
  ...
  fillIntensity: {
    value: 0.3 as const,
    meta: {
      whenToAdjust: '0.1-0.2 for drama, 0.3-0.5 for softness, >0.5 for very flat appearance',
      typicalRange:
  ...
  fillColor: {
    value: '#ffffff' as const,
    meta: {
      whenToAdjust: 'Create color contrast: if key is warm orange, fill should be cool blue',
      typicalRange: 'Warm (#ff9900) → Neutral (#ffffff) → Cool (#4080ff)',
  ...
  rimPosition: {
    ...
    meta: {
      whenToAdjust: 'Vary angle for different rim position; up/down for different edge definition',
      typicalRange:
  ...
  rimIntensity: {
    value: 0.5 as const,
    meta: {
      whenToAdjust: '0.1-0.3 for subtle edge, 0.5-0.8 for strong glow effect',
      typicalRange:
  ...
  rimColor: {
    value: '#ffffff' as const,
    meta: {
      whenToAdjust: 'Match theme: pale cyan for cool/calm, pale orange for warm/energetic',
  ...
  enableAmbient: {
    value: true as const,
    meta: {
      whenToAdjust: 'Disable for dramatic high-contrast lighting, enable for balanced scene',
      typicalRange: 'false (dramatic) → true (standard)',
      interactsWith: ['ambientIntensity', 'ambientColor'],
    } as PropMetadata,
  },
  enableKey: {
    value: true as const,
    meta: {
      whenToAdjust: 'Disable to test ambient-only mood, enable for standard 3-point lighting',
      typicalRange: 'false (ambient-only) → true (standard)',
      interactsWith: ['keyPosition', 'keyIntensity', 'keyColor'],
    } as PropMetadata,
  },
  enableFill: {
    value: true as const,
    meta: {
      whenToAdjust: 'Disable for dramatic shadows, enable for soft natural lighting',
      typicalRange: 'false (hard shadows) → true (soft fill)',
      interactsWith: ['fillPosition', 'fillIntensity', 'fillColor'],
    } as PropMetadata,
  },
  enableRim: {
    value: true as const,
    meta: {
      whenToAdjust: 'Disable for minimal setup, enable for edge glow separation',
      typicalRange: 'false (minimal) → true (edge definition)',
      interactsWith: ['rimPosition', 'rimIntensity', 'rimColor'],
    } as PropMetadata,
  },
} as const;
...
export const ENVIRONMENT_DEFAULTS = {
  enableStars: {
    value: true as const,
    meta: {
      whenToAdjust: 'Disable for minimal aesthetic, enable for space atmosphere',
  ...
  enableFloor: {
    value: true as const,
    meta: {
      whenToAdjust: 'Disable for floating aesthetic, enable for grounded feel',
  ...
  floorOpacity: {
    value: 0.5 as const,
    meta: {
      whenToAdjust: '0.3-0.5 for subtle reference, 0.7+ for visible presence',
      typicalRange: 'Ghost-like (0.2) → Subtle (0.5) → Visible (0.8)',
      interactsWith: ['backgroundColor'],
    } as PropMetadata,
  },
  enablePointLight: {
    value: true as const,
    meta: {
      whenToAdjust: 'Disable for directional-only lighting, enable for ambient glow',
  ...
  lightIntensityMin: {
    value: 0.5 as const,
    meta: {
      whenToAdjust: '0.2-0.5 for subtle glow, 0.8-1.5 for prominent, 2.0+ for bright',
      typicalRange: 'Subtle (0.2) → Standard (0.5) → Prominent (1.0) → Bright (2.0+)',
  ...
  lightIntensityRange: {
    value: 1.5 as const,
    meta: {
      whenToAdjust: '0.5-1.0 for subtle breathing, 1.5-2.5 for pronounced pulse',
      typicalRange: 'Subtle (0.5) → Moderate (1.5) → Strong (2.5) → Extreme (3.0+)',
    } as PropMetadata,
  },
} as const;
...
export const BREATHING_DEBUG_DEFAULTS = {
  enableManualControl: {
    ...
    meta: {
      whenToAdjust: 'Enable for detailed frame-by-frame visual inspection and animation debugging',
  ...
  manualPhase: {
    ...
    meta: {
      ...
      typicalRange: 'Start (0.0, fully exhaled) → Half (0.5, middle) → End (1.0, fully inhaled)',
  ...
  isPaused: {
    value: false as const,
    meta: {
      whenToAdjust: 'Pause at key moments: inhale/exhale transitions, peak breathing',
  ...
  timeScale: {
    value: 1.0 as const,
    meta: {
      whenToAdjust: '0.1-0.5 for slow-motion analysis, 2.0-5.0 for quick iteration',
      typicalRange: 'Very slow (0.1, 10x slower) → Normal (1.0, realtime) → Fast (5.0, 5x faster)',
  ...
  jumpToPhase: {
    value: undefined,
    meta: {
      whenToAdjust: 'Jump to analyze specific phases: 0 (inhale), 2 (exhale), etc.',
      typicalRange: 'Inhale (0) → Hold-in (1) → Exhale (2) → Hold-out (3)',
      interactsWith: ['manualPhase'],
    } as PropMetadata,
  },
  showOrbitBounds: {
    value: false as const,
    meta: {
      whenToAdjust: 'Enable to visualize particle orbit range and breathing proportions',
  ...
  showPhaseMarkers: {
    value: false as const,
    meta: {
      whenToAdjust: 'Enable to learn/verify cycle timing and phase transitions',
  ...
  showTraitValues: {
    value: false as const,
    meta: {
      whenToAdjust: 'Enable to inspect exact animation state and validate algorithm',
...
export const PARTICLE_DEBUG_DEFAULTS = {
  userParticleGeometry: {
    ...
    meta: {
      ...
      performanceNote: 'All geometries have similar cost; choice is purely visual',
    } as PropMetadata,
  },
  userParticleDetail: {
    value: 2 as const,
    meta: {
      whenToAdjust: '0-1 on mobile for performance, 2-3 for balanced, 4 for premium quality',
      typicalRange: 'Low (0, angular) → Medium (2, balanced) → High (4, smooth)',
      interactsWith: ['userParticleGeometry'],
      performanceNote: 'Moderate impact; higher detail increases vertex buffer size',
    } as PropMetadata,
  },
  userParticleScale: {
    value: 1.2 as const,
    meta: {
      whenToAdjust: '0.5-0.8 (small, de-emphasized), 1.0-1.5 (prominent), 2.0+ (very large)',
      typicalRange: 'Small (0.5) → Standard (1.2, default) → Large (2.0)',
  ...
  userParticlePulse: {
    ...
    meta: {
      ...
      typicalRange: 'Static (0.0) → Subtle (0.1) → Standard (0.2) → Strong (0.5)',
  ...
  fillerParticleGeometry: {
    ...
    meta: {
      ...
      typicalRange: 'icosahedron (match user particles) → sphere/box (distinct style)',
  ...
  fillerParticleDetail: {
    value: 2 as const,
    meta: {
      whenToAdjust: 'Same as userParticleDetail; typically should match for visual consistency',
      typicalRange: 'Low (0, angular) → Medium (2, balanced) → High (4, smooth)',
  ...
  fillerParticleScale: {
    value: 0.8 as const,
    meta: {
      whenToAdjust: '0.5-0.7 (small, visually recede), 0.8-1.0 (similar to users)',
      typicalRange: 'Small (0.5) → Standard (0.8, default) → Large (1.5)',
      interactsWith: ['userParticleScale'],
      performanceNote: 'Should be visually distinct; typically 60-70% of user scale',
    } as PropMetadata,
  },
  fillerParticlePulse: {
    value: 0.1 as const,
    meta: {
      whenToAdjust: 'Typically lower than userParticlePulse to de-emphasize filler particles',
      typicalRange: 'Static (0.0) → Subtle (0.1, default) → Strong (0.5)',
  ...
  showParticleTypes: {
    value: false as const,
    meta: {
      whenToAdjust: 'Enable to visualize orbit separation and particle distribution',
      typicalRange: 'false (hidden) → true (visible orbits)',
    } as PropMetadata,
  },
  showParticleStats: {
    value: false as const,
    meta: {
      whenToAdjust: 'Enable to monitor particle status and adaptive quality throttling',
      typicalRange: 'false (hidden) → true (visible stats)',
    } as PropMetadata,
  },
} as const;
...
export const EXPERIMENTAL_DEFAULTS = {
  curveType: {
    ...
    meta: {
      whenToAdjust: 'Compare algorithms using waveDelta fine-tuning',
      typicalRange: 'phase-based (production) → rounded-wave (experimental)',
  ...
  showCurveInfo: {
    value: false as const,
    meta: {
      whenToAdjust: 'Enable when comparing phase-based vs rounded-wave to visualize differences',
 ...
 */
// biome-ignore lint/suspicious/noExplicitAny: Dynamic object spreading requires flexible typing
...
export function createParticleConfigs() {
  const userConfig: ParticleVisualConfig = {
    ...
    material: {
      ...
      transparent: true,
      depthWrite: false,
      // biome-ignore lint/suspicious/noExplicitAny: THREE.AdditiveBlending value (numeric constant)
      blending: 2 as any,
    },
    size: {
