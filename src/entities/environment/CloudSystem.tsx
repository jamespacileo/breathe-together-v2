...
export const CLOUD_CONFIGS: CloudConfig[] = [
  ...
  // === OUTER LAYER (radius 11-13) - 6 clouds (increased from 4) ===
  {
    id: 'outer-mist-1',
    sphereIndex: 0,
    layerTotal: 6,
  ...
  // === DISTANT LAYER (radius 18-25) - 8 clouds, far background ===
  {
    id: 'distant-mist-1',
    sphereIndex: 0,
    layerTotal: 8,
    radius: 18,
    color: '#e8e4e8', // Cool mist
    opacity: 0.45,
    orbitSpeed: 0.002,
    segments: 32,
    bounds: [12, 4, 8],
  ...
  {
    id: 'distant-lavender-2',
    sphereIndex: 1,
    layerTotal: 8,
    radius: 20,
    color: '#d0c8e0', // Faded lavender
    opacity: 0.4,
    orbitSpeed: 0.0018,
    segments: 30,
    bounds: [11, 3.5, 7],
