...
import { DEFAULT_SPHERE_CONFIG, type SphereConfig, VISUALS } from '../../constants';
...
function propsToConfig(props: BreathingSphereProps): SphereConfig {
  return {
    visuals: {
      ...
      chromaticAberration:
        props.chromaticAberration ?? DEFAULT_SPHERE_CONFIG.visuals.chromaticAberration,
      fresnelIntensityBase:
        props.fresnelIntensityBase ?? DEFAULT_SPHERE_CONFIG.visuals.fresnelIntensityBase,
      fresnelIntensityRange:
        props.fresnelIntensityRange ?? DEFAULT_SPHERE_CONFIG.visuals.fresnelIntensityRange,
    },
    animation: {
      entranceDelayMs: props.entranceDelayMs ?? DEFAULT_SPHERE_CONFIG.animation.entranceDelayMs,
      entranceDurationMs:
        props.entranceDurationMs ?? DEFAULT_SPHERE_CONFIG.animation.entranceDurationMs,
      enableOrganicPulse:
        props.enableOrganicPulse ?? DEFAULT_SPHERE_CONFIG.animation.enableOrganicPulse,
      organicPulseSpeed:
        props.organicPulseSpeed ?? DEFAULT_SPHERE_CONFIG.animation.organicPulseSpeed,
      organicPulseIntensity:
        props.organicPulseIntensity ?? DEFAULT_SPHERE_CONFIG.animation.organicPulseIntensity,
    },
    geometry: {
      segments: props.segments ?? DEFAULT_SPHERE_CONFIG.geometry.segments,
      mainGeometryDetail:
        props.mainGeometryDetail ?? DEFAULT_SPHERE_CONFIG.geometry.mainGeometryDetail,
    },
    layers: {
