			...
			{isOpen && (
				...
				>
						...
						>
							<div
								style={{
									...
									height: '100%',
									background: performanceMetrics.isThrottling
										? '#ff6b6b'
										: '#51cf66',
					...
					<div style={{ fontSize: 11, opacity: 0.6, lineHeight: 1.5 }}>
						{preset === 'auto' &&
							'Automatically adjusts quality based on frame rate'}
						{preset === 'low' &&
							'100 particles, 32-segment sphere, minimal effects'}
						{preset === 'medium' &&
							'200 particles, 64-segment sphere, full effects'}
						{preset === 'high' &&
							'300 particles, 128-segment sphere, enhanced effects'}
					</div>
