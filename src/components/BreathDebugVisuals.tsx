        ...
        ============================================================ */}
			{showOrbitBounds && (
				<group ref={orbitsRef}>
					...
					<mesh>
						<sphereGeometry
							args={[VISUALS.PARTICLE_ORBIT_MIN, 32, 32]}
						/>
						<meshBasicMaterial
							color="#00ff00"
							wireframe
					...
					<mesh>
						<sphereGeometry
							args={[VISUALS.PARTICLE_ORBIT_MAX, 32, 32]}
						/>
						<meshBasicMaterial
							color="#ff0000"
							wireframe
