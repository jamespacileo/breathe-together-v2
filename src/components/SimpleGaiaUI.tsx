...
export function SimpleGaiaUI({
  ...
  // Note: Phase indicator has been moved to PhaseOverlay component
  ...
  // Note: Phase indicator RAF loop has been moved to PhaseOverlay component
  ...
  return (
    ...
    >
      ...
      {/* Note: Phase indicator moved to PhaseOverlay component */}
