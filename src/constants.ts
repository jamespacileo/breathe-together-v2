...
export const VISUALS = {
  ...
  // Nebula shader colors (per preset) - brightened for visibility
  NEBULA_COLOR_EXHALE_MEDITATION: '#3a5468', // Brighter cool blue (calm, visible)
  NEBULA_COLOR_INHALE_MEDITATION: '#6a5040', // Brighter warm amber (energizing, visible)
  NEBULA_COLOR_EXHALE_COSMIC: '#1a1a3a', // Deep blue-black (deep space)
  NEBULA_COLOR_INHALE_COSMIC: '#3a2050', // Brighter purple (cosmic energy)
  NEBULA_COLOR_EXHALE_MINIMAL: '#1a1814', // Warm grey (neutral, subtle)
  NEBULA_COLOR_INHALE_MINIMAL: '#1a1814', // Warm grey (no transition)
  NEBULA_COLOR_EXHALE_STUDIO: '#1a1a2e', // Cool grey (neutral, subtle)
